...
class DetailPageModel {
  ...
  DetailPageModel({this.code, this.message, this.data});

  DetailPageModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
...
class DetailDAta {
  ...
  DetailDAta({this.goodInfo, this.goodComments, this.advertesPicture});
